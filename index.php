                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                ...
                                <p class="feature-card-desc">MIB offers Market research, Insights, Business Intelligence, Analytics, Survey – CATI & F2F, and consulting services by adopting integrated business model. 
Our data driven solutions help our clients improve business performance, see an increase in sales, and stay ahead of their competitors. 
We specialize in research, measurement, statistical modeling, and branding & communication studies offering comprehensive solutions
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-card">
                            ...
                            <div class="feature-card-content">
                                ...
                                MIB offers Market research, Insights, Business Intelligence, Analytics, Survey – CATI & F2F, 
                                and consulting services by adopting integrated business model. 
                              Our data driven solutions help our clients improve business performance, see an increase in sales, and stay ahead of their competitors.
                         We specialize in research, measurement, statistical modeling,
...
Offering Segmentation, Brand Engagement, Positioning & Targeting</p>
                    <h2 class="heading--title color-white mb-0">Witness profitable presence on web optimize online stores, develop precise plans, and identify growth opportunities by utilizing digital marketing</h2>
                </div>
            </div>
            <!-- .col-lg-10 end -->
        </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="info-card">
                    ...
                    <div class="info-card-content">
                        ...
                        <p class="info-card-desc">Our tailor made solutions help our clients improve business performance, see an increase in sales, and stay ahead of their competitors.
                         We specialize in research, measurement, and branding & communication studies</p>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="info-card">
                    ...
                    <div class="info-card-content">
                        ...
                        <p class="info-card-desc">To reach your target audience we focus on the Place, Price, Promotion, Physical Evidence, People, Product, and Process. 
                        Our extended marketing mix meets the requirements of both product and service based business.</p>
                        <a class="info-card-links" href="#"><i class="fa fa-plus"></i>Read More</a>
                    </div>
                </div>
                <!-- .info-card end -->
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
                <div class="info-card">
                    ...
                    <div class="info-card-content">
                        ...
                        <p class="info-card-desc">Your consumers are busy and there’s limited time to present the value of
                         your product or service to them else they move on. 
                        Amidst such complexity your brand presence does most 
                        of the talking and when your consumers share it with others is the cherry on the topping.</p>
                        <a class="info-card-links" href="#"><i class="fa fa-plus"></i>Read More</a>
                    </div>
                </div>
                <!-- .info-card end -->
